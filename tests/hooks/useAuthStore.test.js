...
describe('Pruebas en useAuthStore', () => {
    ...
    test('startRegister debe de crear un usuario', async() => {
        ...
        //para hacer un mock parcial y no enviar informacion de prueba a la dba 
        ...
        //eliminar el spy para otras pruebas
        spy.mockRestore();
    ...
    test('checkAuthToek debe de fallar si no hay token', async() => {
        const mockStore = getMockStore({...initialState});
        const {result} = renderHook( () => useAuthStore(), {
            wrapper: ( {children} ) => <Provider store={ mockStore }> {children} </Provider>
        } );
    ...
    test('checkOutToken debe de autenticar el usuario si no hay un token', async() => {
